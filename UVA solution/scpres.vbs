...
'Open the file
Set objWorkbook = objExcel.Workbooks.Open(p_strFilePath, , , ,PASSWORD)
'Save the PDF
...
'Open the file
Set objDocument = objWord.Documents.Open(p_strFilePath, , , ,PASSWORD)
'Save the PDF
